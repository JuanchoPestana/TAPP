//
//  NipConfiguracionViewController.h
//  Tapp
//
...
@interface NipConfiguracionViewController : UIViewController <UITextFieldDelegate>

// IMAGEN FONDO TECLADO
@property (weak, nonatomic) IBOutlet UIImageView *imagen_fondo_teclado;

// VIEW TECLADO
@property (weak, nonatomic) IBOutlet UIView *teclado_nip_configuracion;

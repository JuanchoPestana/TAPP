...
- (void)setDefaultParameters
{
    ...
    _innerGridColor = [UIColor clearColor];
    _drawInnerGrid = YES;
    ...
    _indexLabelFont = [UIFont fontWithName:@"SFUIDisplay-Ultralight" size:19];
    
    _valueLabelBackgroundColor = [UIColor clearColor];
    _valueLabelTextColor = [UIColor grayColor];
    _valueLabelFont = [UIFont fontWithName:@"SFUIDisplay-Ultralight" size:21];
...
- (UILabel*)createLabelForValue: (NSUInteger)index
{
    ...
    UILabel* label = [[UILabel alloc] initWithFrame:CGRectMake(p.x - xOffset, p.y - 10, width + 2, 17)];
    label.text = text;
...
- (UILabel*)createLabelForIndex: (NSUInteger)index
{
    ...
    UILabel* label = [[UILabel alloc] initWithFrame:CGRectMake(p.x - 10.0f, p.y + 10, width + 2, 17)];
    label.text = text;

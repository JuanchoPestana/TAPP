...
#import "FirmaModoTPVViewController.h"

@interface FirmaModoTPVViewController ()

@end

NSString *fecha_firma_modo_tpv;


@implementation FirmaModoTPVViewController
...
- (IBAction)accion_continuar:(id)sender {
    ...
    _imageView_guardar.image = SaveImage;
...
- (void)guardarImagenServidor{
    ...
    NSString *nombre_firma = [NSString stringWithFormat:@"%@-%@", nombre_usuario, fecha_firma_modo_tpv];
    ...
    UIImage *imagen_firma_img =_imageView_guardar.image;
